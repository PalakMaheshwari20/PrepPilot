...
from app.api.routes.study_session import router as study_session_router
from app.api.routes.reset import router as reset_router
...
api_router.include_router(study_session_router)